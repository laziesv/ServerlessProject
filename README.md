...
> ระบบจัดการงานส่วนตัวแบบ To-do List สำหรับเพิ่ม ติดตาม และจัดลำดับความสำคัญของงานผ่านเว็บแอปอย่างสะดวกและเป็นระบบ
...
### แอปพลิเคชัน
- **ชื่อ:** ระบบ To-do List 
- **ประเภท:** Web App
- **ภาษา / Framework:** 
    - **Frontend:** Next.Js, TypeScript, TailWind CSS
    - **Backend:** Golang,PostgreSQL
- **คำอธิบาย:** แอป To-Do List เป็นเว็บแอปสำหรับช่วยผู้ใช้บันทึก จัดการ และติดตามงานหรือกิจกรรมที่ต้องทำในแต่ละวัน ผู้ใช้สามารถเพิ่ม แก้ไข ลบ และกำหนดสถานะหรือระดับความสำคัญของงานได้ เพื่อช่วยวางแผนและบริหารเวลาได้มีประสิทธิภาพมากขึ้น ระบบถูกพัฒนาขึ้นเพื่อแก้ปัญหาการลืมงาน ความไม่เป็นระเบียบในการจัดการงาน และช่วยให้การติดตามความคืบหน้าของงานทำได้ง่ายขึ้น
